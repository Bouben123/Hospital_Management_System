	...
	<div class='sidebar'>
		<div class='sidebar-area'> 
			...
			<ul class='sidebar-menu'>
				...
				<li><a href='help.php'><img class='sidebar-menu-icon' src='images/ic_help_outline_white_24dp.png'  /> Help </a></li>
				...
				<li><a href='serill.php'><img class='sidebar-menu-icon' src='images/ic_error_outline_white_24dp.png'  /> Serious-ill</a></li>
				<li><a href='reports.php'><img class='sidebar-menu-icon' src='images/ic_receipt_white_24dp.png'  /> Ser-ill Reports</a></li>
			</ul> 
		</div> 
	</div>
	<?php 
